...
export RK_PARTITION_CMD_IN_ENV="256K(env),256K@256K(idblock),512K(uboot),4M(boot),120M(rootfs)"
...
export RK_CUSTOM_ROOTFS="/home/leo/luckfox-pico/sysdrv/custom_rootfs/alpine.tar.gz"
